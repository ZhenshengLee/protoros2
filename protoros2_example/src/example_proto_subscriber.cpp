...
public:
  ExampleProtoSubscriber() : Node("example_proto_subscriber_cpp")
  {
    ...
    subscription_ =
      this->create_subscription<protoros2_example::msg::pb::ExampleMessage>("proto_msg_topic", 10, topic_callback);
  }

private:
  rclcpp::Subscription<protoros2_example::msg::pb::ExampleMessage>::SharedPtr subscription_;
};
