...
public:
  ...
  {
    publisher_ = this->create_publisher<protoros2_example::msg::pb::ExampleMessage>("proto_msg_topic", 10);
    auto timer_callback = [this]() -> void {
      auto message = protoros2_example::msg::pb::ExampleMessage();
...
private:
  ...
  rclcpp::Publisher<protoros2_example::msg::pb::ExampleMessage>::SharedPtr publisher_;
  size_t count_;
};
